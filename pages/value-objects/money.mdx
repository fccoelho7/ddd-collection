...
describe("Money", () => {
  ...
  describe("add", () => {
    it("should correctly add two Money instances with the same currency", () => {
      const money1 = new Money(100, "USD");
      const money2 = new Money(50, "USD");
      const result = money1.add(money2);
    ...
    it("should throw an error when trying to add Money instances with different currencies", () => {
      const money1 = new Money(100, "USD");
